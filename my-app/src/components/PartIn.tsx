  ...
  return (
    <div
      className="flex flex-col items-start justify-center pt-24 px-24 h-[900px] bg-lined x:items-start x:text-left x:pt-8 x:justify-start x:h-full
            x:pl-4 x:pr-0"
    >
      <h1 className="text-8xl font-bold mb-3 x:text-5xl">Как участвовать?</h1>
      <p className="text-3xl mb-12 x:mb-4">
        Вам нужно заполнить простую форму, зайти в каналы и ждать новостей
      </p>
      <div className="flex flex-row gap-12 items-center mb-60 x:w-full x:gap-6 md:flex-col md:items-start">
        <button
