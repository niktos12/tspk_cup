        ...
        >
            ...
            >
                ...
                >
                    ...
                    <FaTelegramPlane 
                        className="text-[#0D0D0E] p-2 w-[52px] h-[52px] rounded-2xl 
                        bg-[#D4E1FF] cursor-pointer transition-all duration-300 hover:text-[#3773FF] hover:rounded-full "
                    />
                    <FaDiscord 
                        className="text-[#0D0D0E] p-2 w-[52px] h-[52px] rounded-2xl 
                        bg-[#D4E1FF] cursor-pointer transition-all duration-300 hover:text-[#3773FF] hover:rounded-full "
                    ...
                    <button
                        onClick={openModal}
                        className="ml-6 px-6 py-3 text-2xl font-semibold bg-[#3773FF] text-white rounded-2xl duration-300 after:transition-all "
                    >
                        Участвовать
                    </button>
                </div>
